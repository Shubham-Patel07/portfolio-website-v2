      ...
      >
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Software Developer crafting beautiful & functional digital
              experiences
            </p>
        ...
        <div className="absolute bottom-8 left-0 right-0 flex justify-center">
          <button
            ...
            className="text-violet-600 animate-bounce p-2"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                I'm Shubham Patel, a passionate software developer with
                expertise in building modern web applications. I specialize in
                frontend development with React, creating responsive and
                user-friendly interfaces.
              </p>
              <p className="text-gray-600 mb-6">
                With a strong foundation in software engineering principles and
                best practices, I strive to write clean, maintainable code that
            ...
            >
              <Image
                src="/ProfilePhoto.jpg?height=800&width=600"
                alt="Shubham Patel"
                fill
                className="object-cover"
              />
